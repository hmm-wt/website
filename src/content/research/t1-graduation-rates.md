...
summary: How regulated (T1) companies progress through funding stages relative to unregulated peers. Stage-by-stage round premiums, cumulative funding multiples, and observed exit incidence. The empirical case for licence-as-barrier as a compounding asset.
date: 2026-05-12
version: v1.0
...
The four-market universe sets the denominator. The conservative T1 / T2 classifier sets the screen.

| Stage of filter | Count | Share |
|---|---|---|
| Four-market classified universe (AU + JP + NZ + SG) | **19,416** | 100% |
...
| Stage | Cumulative T1 funding multiple (vs unregulated cohort) |
|---|---|
| Pre-seed | 1.09x |
| Series A | (round premium 1.19x applied to seed entry of 1.12x = ~1.33x cumulative) |
...
| Cohort | Observed exit rate (2018–2024) |
|---|---|
...
## Why the graduation rate compounds

Three mechanisms.

1. **Cleared milestones are sticky.** A TGA SaMD clearance, an MAS Digital Bank licence, or a PMDA SAKIGAKE designation does not expire on the same cycle as a product release. The barrier persists across product iterations.
2. **Cross-jurisdiction recognition.** A T1 company with FDA 510(k) clearance is materially closer to TGA / HSA / Medsafe approval than a competitor starting from zero. Each cleared jurisdiction reduces the cost and time of the next.
3. **Acquirer demand is structural.** Strategic acquirers in regulated industries cannot organically build the compliance layer at the pace the regulatory clock demands. Acquisition is the rational response. The acquirer pool is set by the regulator's perimeter, not the fund's geography.
...
This report does not present T1 / T2 as the only path to venture returns. It does not claim that unregulated companies cannot produce outsized exits. The claim is narrower: inside the four-market regulated-sector seed thesis, the stage-graduation curve is materially steeper than the unregulated comparable.

The dataset behind these figures is the hmm Ventures classified universe (19,416 four-market companies, reference dataset 2026-04-08). Methodology, classification rules, and provenance are documented in Appendix F of The Necessity Index.
...
- Funding-premium analysis, 2024 four-market deal data. Round-size premiums computed as median round size for regulated vs unregulated cohorts at each stage.
- Exit-rate analysis, 2018–2024 four-market observation window. Observed exits include strategic and financial-sponsor acquisitions, IPOs, and reverse mergers.
