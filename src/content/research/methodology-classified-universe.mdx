...
source_dataset: "reference_dataset_classified.csv; regulations_comprehensive.json; four_market_sector_tier_breakdown.csv."
...
- reference_dataset_classified.csv (19,416 four-market companies; 22,217 global).
- regulations_comprehensive.json (725 regulations, 64 countries, 13 sectors).
- four_market_sector_tier_breakdown.csv (174 four-market regulations).
- IM Appendix F (Data Provenance).
