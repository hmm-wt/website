...
Necessity is the thesis. Where regulation defines what an operator can legally launch, connect, sell, export, insure, claim subsidy eligibility for, or continue running, the company that builds the compliant operational layer earns a structural premium. Four markets in developed APAC have built the deepest version of this regulatory architecture. They are where seed-stage value will be captured this decade.
...
The regulatory build is in flight. DORA became enforceable on 17 January 2025. The EU AI Act began phasing in from February 2025. Japan passed its AI Promotion Act in May 2025. Across the four target markets, 34 in-flight regulations are dated 2024 to 2030. This is the build phase of the cycle the doctrine names the *Crystallisation Window*.
...
Seed-stage deployment into markets where the barrier is regulatory has a specific shape. The product is built to a standard before it is built for distribution. Clinical evidence is generated. Safety cases are documented. Quality management systems are established. Licences, certifications, and clearances accumulate.
...
*Chapter 2 introduces the Five Necessities and the empirical anchors that make the thesis testable.*
