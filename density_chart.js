  ...
  function init() {
    ...
    if (!document.getElementById("dc-style")) {
      ...
      style.textContent = [
        ...
        "  --dc-grid:var(--hmm-border);",
        "  --dc-wash:var(--hmm-wash);",
        ...
        "  --dc-grid:var(--hmm-border-light);",
        "  --dc-wash:var(--hmm-wash-light);",
        ...
        "  --dc-panel-bg:var(--hmm-surface-light);",
        "}}",
